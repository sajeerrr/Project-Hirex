...
<main style="padding: 100px 32px; max-width: 800px; margin: 0 auto; min-height: 60vh;">
    <h1 style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 36px; margin-bottom: 24px;">Help Center</h1>
    <p style="font-size: 16px; color: var(--text-secondary); margin-bottom: 32px;">How can we help you today? Browse our frequently asked questions or contact support if you need further assistance.</p>
    
    <div style="background: var(--bg-secondary); border: 1px solid var(--border); border-radius: 16px; padding: 24px; box-shadow: 0 4px 20px var(--shadow);">
        <h3 style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 18px; margin-bottom: 12px;">Getting Started</h3>
        <p style="color: var(--text-secondary); margin-bottom: 20px;">Learn how to search for professionals, book a job, and manage your account settings.</p>
        
        <h3 style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 18px; margin-bottom: 12px;">Payments & Refunds</h3>
        <p style="color: var(--text-secondary); margin-bottom: 20px;">Information about secure payments, our refund policy, and how to track your expenses.</p>
        
        <h3 style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 18px; margin-bottom: 12px;">Trust & Safety</h3>
        <p style="color: var(--text-secondary); margin-bottom: 20px;">How we verify our professionals and ensure a safe experience for every booking.</p>
    </div>
