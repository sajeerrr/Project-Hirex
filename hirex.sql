...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2026 at 07:57 PM
...
(1, 1, 2, '2026-04-12 14:00:00', 3, 'trivandrum', 'worker needed', 1050, 'confirmed', '2026-04-12 15:57:33', NULL),
(2, 1, 11, '2026-04-25 03:00:00', 2, 'trivandrum', '', 800, 'completed', '2026-04-25 20:58:17', NULL),
(3, 1, 11, '2026-04-26 12:00:00', 2, 'trivandrum', '', 800, 'completed', '2026-04-26 05:39:33', NULL),
(4, 1, 11, '2026-04-28 11:00:00', 2, 'trivandrum', '', 800, 'completed', '2026-04-28 05:06:30', NULL),
(5, 9, 11, '2026-04-28 11:00:00', 2, 'trivandrum', 'i need a worker', 800, 'completed', '2026-04-28 05:15:34', NULL),
(6, 1, 1, '2026-05-05 22:00:00', 2, 'trivandrum', '', 900, 'cancelled', '2026-05-05 16:17:21', NULL),
(7, 1, 4, '2026-05-05 22:00:00', 2, 'trivandrum', '', 600, 'pending', '2026-05-05 16:24:36', NULL);
...
(7, 1, 'user', 2, 'worker', 'hi', 1, '2026-04-12 18:31:59'),
...
(12, 11, 'worker', 1, 'user', 'hi', 1, '2026-04-28 05:08:37'),
(13, 9, 'user', 1, 'worker', 'hi', 0, '2026-04-28 05:14:35');
...
(3, 9, 1, '2026-04-28 05:15:54'),
(4, 9, 2, '2026-04-28 05:15:56'),
(5, 1, 5, '2026-05-05 16:22:30'),
(6, 1, 8, '2026-05-05 16:24:22');
...
(9, 'simna', 'simna@gmail.com', '$2y$10$wXxuQpml56eVANKvP2VQhewsJnc4mHkoKIiCapfn2eNhJpcwL.Sk.', 'trivandrum', '2026-04-28 05:10:59', 'user', '1234567890', 'life is good', '', 'active');
...
(11, 'Bob', 'Painter', 5, 400, 1, 0, 'worker_11_1777147822.jpg', '2 yrs', 0, 'panachamoodu', 'bob@gmail.com', '$2y$10$aC6889dRTnEWpk1o1pfHiej7ACcQJF1gLcDFdxSr5P2qiJoG.Z23S', '1234567890', 'active', '2026-04-25 18:05:44', 'trivandrum', 'loyal worker'),
...
--
-- Table structure for table `worker_verifications`
--
...
CREATE TABLE `worker_verifications` (
  ...
  `portfolio_status` enum('pending','verified','failed') DEFAULT 'pending',
...
--
-- Indexes for table `worker_verifications`
--
...
--
-- AUTO_INCREMENT for table `worker_verifications`
--
ALTER TABLE `worker_verifications`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `worker_portfolio`
--
ALTER TABLE `worker_portfolio`
  ADD CONSTRAINT `worker_portfolio_ibfk_1` FOREIGN KEY (`verification_id`) REFERENCES `worker_verifications` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `worker_verifications`
--
ALTER TABLE `worker_verifications`
  ADD CONSTRAINT `worker_verifications_ibfk_1` FOREIGN KEY (`worker_id`) REFERENCES `workers` (`id`) ON DELETE CASCADE;
COMMIT;
